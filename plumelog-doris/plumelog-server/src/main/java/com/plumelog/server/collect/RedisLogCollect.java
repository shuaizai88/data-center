...
public class RedisLogCollect extends BaseLogCollect {
    ...
    public RedisLogCollect(AbstractServerClient elasticLowerClient, AbstractClient redisQueueClient, ApplicationEventPublisher applicationEventPublisher, boolean compressor, AbstractClient redisClient) {
