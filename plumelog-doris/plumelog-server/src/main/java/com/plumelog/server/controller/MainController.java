...
//        }
    ...
    public String clientQuery(@RequestBody String queryStr, String size, String from, String clientStartDate,
                              String clientEndDate, String trace, String type) {
...
//        }
        ...
        try {
            return abstractServerClient.get(indexStr, queryStr, from, size, type);
        } catch (Exception e) {
