package com.xhb.dc.kettle.run.steps.connection.controller;

import com.xhb.dc.kettle.core.util.StatusCode;
import com.xhb.dc.kettle.core.model.Result;

import com.xhb.dc.kettle.run.datasource.feign.DatasourceServiceApiClient;
import com.xhb.dc.kettle.run.steps.connect.api.DBConnectServiceApi;
import com.xhb.dc.kettle.run.steps.connect.dto.FieldDTO;
import com.xhb.dc.kettle.run.steps.connect.dto.PreviewDataInfoDTO;
import com.xhb.dc.kettle.run.steps.connect.dto.ProcedureDTO;
import com.xhb.dc.kettle.run.steps.connect.vo.ConnectionDetailVO;
import com.xhb.dc.kettle.run.steps.connect.vo.QueryVO;
import com.xhb.dc.kettle.run.steps.connection.service.DataBaseInputService;
