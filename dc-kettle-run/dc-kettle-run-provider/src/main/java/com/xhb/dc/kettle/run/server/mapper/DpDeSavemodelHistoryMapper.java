package com.xhb.dc.kettle.run.server.mapper;

import com.xhb.dc.kettle.run.server.dto.SavemodelHistoryDTO;
import com.xhb.dc.kettle.run.server.entity.DpDeSavemodelHistory;
