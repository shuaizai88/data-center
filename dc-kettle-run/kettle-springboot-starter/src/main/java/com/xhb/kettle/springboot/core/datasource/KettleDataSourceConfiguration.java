package com.xhb.kettle.springboot.core.datasource;
 ...
 */
@Configuration
@MapperScan(basePackages = "com.xhb.kettle.springboot.core.mapper", sqlSessionTemplateRef = "EngineMetaDataSqlSessionTemplate")
public class KettleDataSourceConfiguration {
    ...
    public SqlSessionFactory sqlSessionFactory(@Qualifier(EngineMetaDataJdbcTemplate.DS_NAME) DataSource dataSource) throws Exception {
        ...
        sessionFactory.setMapperLocations(new PathMatchingResourcePatternResolver()
                .getResources("classpath*:/com/xhb/kettle/springboot/core/mapping/*.xml"));
